...
class Supervisor:
    ...
    def run(self):
        ...
        a1 = Agent(0, float(self.m[0]), self.dt, self.t, self.X_feasible, self.U_feasible, self.Np_agents, self.Q, self.R, self.tolerance)
        a2 = Agent(1, float(self.m[1]), self.dt, self.t, self.X_feasible, self.U_feasible, self.Np_agents, self.Q, self.R, self.tolerance)
        a3 = Agent(2, float(self.m[2]), self.dt, self.t, self.X_feasible, self.U_feasible, self.Np_agents, self.Q, self.R, self.tolerance)
